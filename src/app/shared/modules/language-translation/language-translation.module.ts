/**
 * Módulo usado para traduções de idiomas.
 * As traduções são salvas em um arquivo json no diretório / src / app / assets / i18n
 * Documentos: https://www.codeandweb.com/babeledit/tutorials/how-to-translate-your-angular7-app-with-ngx-translate
 */
